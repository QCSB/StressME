...
def return_me_model():
    ...
    me.global_info['propensity_scaling'] = .14
    ...
    ## FoldME_new_david.pickle
    #me.ngam = 19.42
    #me.gam = 43.89
    # FoldME_new_sasa.pickle
    me.ngam = 19.48
    me.gam = 23.21
    ...
    pd = 0.25
    pg = 0.05
    ecolime.chaperones.add_foldme_module(me,pd,pg)
    ...
    # ## Part 11: Fix ETC stoichiometry
    etc_reaction='ATPS4rpp'
    print(me.process_data.get_by_id(etc_reaction).stoichiometry)
    me.process_data.get_by_id(etc_reaction).stoichiometry['h_p']=-3.3
    me.process_data.get_by_id(etc_reaction).stoichiometry['h_c']=2.3
    print(me.process_data.get_by_id(etc_reaction).stoichiometry)

    data=me.process_data.get_by_id(etc_reaction)
    for r in data.parent_reactions:
        print(r.id)
        me.reactions.get_by_id(r.id).update()


    etc_reaction='NADH16pp'
    print(me.process_data.get_by_id(etc_reaction).stoichiometry)
    me.process_data.get_by_id(etc_reaction).stoichiometry['h_p']=4.0
    me.process_data.get_by_id(etc_reaction).stoichiometry['h_c']=-5.0
    print(me.process_data.get_by_id(etc_reaction).stoichiometry)
    ...
    me.unmodeled_protein_fraction = 0.48
    me.ngam = 13.58
    me.gam = 19.49
    #me.gam = 62.0
    #me.ngam = 0.
...
if __name__ == '__main__':
    ...
    me = return_me_model()
    with open("%s/Models/ETC_model_2.pickle" % here, "wb") as outfile:
