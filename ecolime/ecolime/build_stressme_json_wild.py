...
if __name__ == '__main__':
    ...
    me = return_me_model()
    with open("%s/EcoliME_wildtype.pickle" % here, "wb") as outfile:
        pickle.dump(me, outfile)
    with open("%s/me_models/EcoliME_wildtype.pickle" % here, "wb") as outfile:
        pickle.dump(me, outfile)

    save_json_me_model(me, "%s/me_models/EcoliME_wildtype.json" % here)
