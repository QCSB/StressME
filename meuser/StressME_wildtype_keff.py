...
with open("FoldME_Ali_keff.pickle", "rb") as f:
  me = pickle.load(f)
#################################
#To set up DXPRIi keff so that the strain was not adapted to thermal stress (wild type)
#################################
...
output_filename='StressME_wildtype_proteome.csv'
...
solution_file_path='/home/meuser'
output_filename='StressME_wildtype_phenotypes.csv'
...
solution_file_path='/home/meuser'
output_filename='StressME_wildtype_fluxes.csv'
